...
fn skills() -> Vec<SkillDef> {
    vec![
        SkillDef {
            ...
            content: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/skills/typspec-propose/SKILL.md")),
        },
        SkillDef {
            dir_name: "typspec-explore",
            content: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/skills/typspec-explore/SKILL.md")),
        },
        SkillDef {
            dir_name: "typspec-apply",
            content: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/skills/typspec-apply/SKILL.md")),
        },
        SkillDef {
            dir_name: "typspec-archive",
            content: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/skills/typspec-archive/SKILL.md")),
        },
    ]
}
